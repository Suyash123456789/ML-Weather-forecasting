...
#print(htmlcontent)
soup=BeautifulSoup(htmlcontent,"html.parser")
speed2=soup.find_all("span", {"class": "Wind--windWrapper--3aqXJ DailyContent--value--37sk2", "data-testid": "Wind"})
#print(speed2)
all_speed2=[]
for word in speed2:
...
#print(htmlcontent)
soup=BeautifulSoup(htmlcontent,"html.parser")
speed3=soup.find_all("span", {"class": "Wind--windWrapper--3aqXJ DailyContent--value--37sk2", "data-testid": "Wind"})
#print(speed3)
all_speed3=[]
for word in speed3:
...
#print(htmlcontent)
soup=BeautifulSoup(htmlcontent,"html.parser")
hum1=soup.find_all("span", {"class": "DetailsTable--value--1q_qD", "data-testid": "PercentageValue"})
#print(hum1)
all_hum1=[]
for word in hum1:
...
#print(htmlcontent)
soup=BeautifulSoup(htmlcontent,"html.parser")
hum2=soup.find_all("span", {"class": "DetailsTable--value--1q_qD", "data-testid": "PercentageValue"})
#print(hum2)
all_hum2=[]
for word in hum2:
    all_humx = word.get_text()
...
#print(htmlcontent)
soup=BeautifulSoup(htmlcontent,"html.parser")
hum3=soup.find_all("span", {"class": "DetailsTable--value--1q_qD", "data-testid": "PercentageValue"})
#print(hum3)
all_hum3=[]
for word in hum3:
    all_humx = word.get_text()
...
def home():
    ...
    return render_template('index.html', mum_predict=m_predict,mhum=all_hum1[0],mspeed=wspeed1[0],mum_predict2=m_predict2,mhum2=all_hum1[1],mspeed2=wspeed1[1],mum_predict3= m_predict3,mhum3=all_hum1[2],mspeed3=wspeed1[2],
